...
//code will not compile unless uncommeting these values, ignore the boolean values
 ...
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 500 } //previously I
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,1010,94.5}  //Previous values II
#define DEFAULT_AXIS_STEPS_PER_UNIT   {40,40,1010,100} //Previous values III
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
//#define DEFAULT_MAX_FEEDRATE          { 300, 300, 5, 25 } previously
...
// *** This is the main thing to look when using for different printers to change the extruder speed. ACCELARATION
...
// Chnged #define X_HOME_DIR -1 default value
#define X_HOME_DIR 1
#define Y_HOME_DIR -1
#define Z_HOME_DIR -1
//#define I_HOME_DIR -1
